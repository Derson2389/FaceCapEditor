...
public class DirectorRoomRecorderManager : RecorderManager
{
    ...
    private void RefreshGateCameraData()
    {
        ...
        foreach (MBRootNodeInfo nodeInfo in MontionRecorderServer.Instance.CameraList)
        {
            DynamicAddNew(nodeInfo);
        }
    }
    ...
    public void DynamicAddNew(MBRootNodeInfo nodeInfo)
    {
        GameObject obj = new GameObject(nodeInfo.NodeName);
        ...
        director.InitData(camera, nodeInfo);
