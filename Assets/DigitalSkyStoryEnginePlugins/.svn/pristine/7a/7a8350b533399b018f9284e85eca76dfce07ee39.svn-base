...
namespace UnityEngine.XR.iOS.Utils
{
    ...
    //@hushuang
    [Serializable]
    public class serializableUnityARFaceBlendShapes
    {
        public byte[] data;

        public serializableUnityARFaceBlendShapes(byte[] inputDatas)
        {
            data = inputDatas;
        }

        public static implicit operator serializableUnityARFaceBlendShapes(Dictionary<string, float> blendshapeData)
        {
            if (blendshapeData != null)
            {
                ...
                return new serializableUnityARFaceBlendShapes(stream.GetBuffer());
            }
            else
            {
                return new serializableUnityARFaceBlendShapes(null);
            }
        }

        public static implicit operator Dictionary<string, float>(serializableUnityARFaceBlendShapes spc)
        {
            if (spc.data != null)
            {
