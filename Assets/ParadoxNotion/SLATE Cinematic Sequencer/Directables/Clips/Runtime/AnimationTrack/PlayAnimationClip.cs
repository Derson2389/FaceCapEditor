...
namespace Slate.ActionClips{
	...
	public class PlayAnimationClip : ActorActionClip<Animation>, ICrossBlendable, ISubClipContainable{
		...
		public override bool isValid
        {
            get
            {
                return base.isValid && ((animationClip != null && animationClip.legacy) || !string.IsNullOrEmpty(animationClipPath));
            }
        }
        ...
        if (animationClip == null && !string.IsNullOrEmpty(animationClipPath))
        {
            animationClip = UnityEditor.AssetDatabase.LoadAssetAtPath<AnimationClip>(animationClipPath);
        }
