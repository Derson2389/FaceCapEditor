...
namespace Slate
{
    public static class fcAPI
    {
        ...
        public static int fcExrAddLayerTexture(fcEXRContext ctx, RenderTexture tex, int ch, string name, int id, bool flipY)
        {
            return fcExrAddLayerTextureDeferred(ctx, tex.GetNativeTexturePtr(), fcGetPixelFormat(tex.format), ch, name, flipY, id);
        }
