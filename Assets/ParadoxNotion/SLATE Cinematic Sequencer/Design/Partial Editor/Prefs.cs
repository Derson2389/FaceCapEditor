...
namespace Slate{
	...
	public static class Prefs {
		...
		class SerializedData{
			...
			// @TQ
			// add auto cut buttons
            public bool autoCut                        = false;
            public bool autoCutCam                     = false;
            public bool showChoosenTrack               = true;
            public bool showAllGizmoLine               = !true;
            public bool hideAllTrack                   = false;
		...
		public class RenderSettings{
			...
			public RenderFormat renderFormat = RenderFormat.PNGImageSequence;
        ...
        {
            get { return data.autoCut; }
            set { if (data.autoCut != value) { data.autoCut = value; Save(); } }
        }

        public static bool autoCutCam
        {
            get { return data.autoCutCam; }
            set { if (data.autoCutCam != value) { data.autoCutCam = value; Save(); } }
        }

        public static bool showChoosenTrack
        {
            get { return data.showChoosenTrack; }
            set { if (data.showChoosenTrack != value) { data.showChoosenTrack = value; Save(); } }
        }

        public static bool ShowAllGizmoLine
        {
            get { return data.showAllGizmoLine; }
            set { if (data.showAllGizmoLine != value) { data.showAllGizmoLine = value; Save(); } }
        }

        public static bool HideAllTrack
        {
            get { return data.hideAllTrack; }
            set { if (data.hideAllTrack != value) { data.hideAllTrack = value; Save(); } }
        }
